...
class AppDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final rol      = user.role;
    final rolColor = _rolColors[rol] ?? _RolColor(const Color(0x3094A3B8), const Color(0xFF94A3B8));
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Text(
                      'HL',
                      style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 12, letterSpacing: 0.3),
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            rol,
                            style: TextStyle(color: rolColor.text, fontSize: 11, fontWeight: FontWeight.w600),
                          ),
                        ),
                      ],
                    ),
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      ...visible.map((item) => _NavTile(
                        ...
                        onTap: item.soon || item.screenBuilder == null ? null : () {
...
class _NavTileState extends State<_NavTile> {
  ...
  Widget build(BuildContext context) {
    ...
    Color textColor;
    if (active)     textColor = Colors.white;
    else if (soon)  textColor = _textLow;
    else            textColor = _textHigh;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? _activeBg : (_pressed && !soon ? _hoverBg : Colors.transparent),
          border: Border(
            left: BorderSide(
          ...
          children: [
            ...
            if (soon)
              Container(
                ...
                child: const Text(
                  'Pronto',
                  style: TextStyle(color: _textLow, fontSize: 9, fontWeight: FontWeight.w700, letterSpacing: 0.4),
                ),
              ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            Icon(widget.icon, size: 16, color: _pressed ? widget.activeColor : widget.color),
            const SizedBox(width: 10),
            Text(
              widget.label,
              style: TextStyle(
